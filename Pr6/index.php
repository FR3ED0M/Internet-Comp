    ...
    <nav class="navbar navbar-inverse navbar-fixed-bottom" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">BABY NAMES</a>
            </div>
...
$dbname = 'dbupload.php';   // Needs to be changed to your designated table database name
$dbuser = 'username';   // Needs to be changed to reflect your LAMP server credentials
...
<div class="container">
  <h1 class="section-title">Top Baby Names</h1>
    <div class="row">
        <div class="col-lg-11">
        </div>
      <div class="col-lg-12">
